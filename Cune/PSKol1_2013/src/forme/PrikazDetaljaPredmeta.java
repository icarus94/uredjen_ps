 ...
 * @author Miroslav
 */
public class PrikazDetaljaPredmeta extends javax.swing.JDialog {

    /**
     * Creates new form PrikazDetaljaAsistenta
     */
    public PrikazDetaljaPredmeta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ESPB");

        btnZatvori.setText("Zatvori dijalog");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrikazDetaljaPredmeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrikazDetaljaPredmeta dialog = new PrikazDetaljaPredmeta(new javax.swing.JFrame(), true);
    ...
    void setujPredmetINjegovaPolja(Asistent izabraniAsistent) {
        
            txtNAziv.setText(izabraniAsistent.getPredmet().getNazivPredmeta());
            txtSemestar.setText(izabraniAsistent.getPredmet().getSemestar()+"");
            txtESPB.setText(izabraniAsistent.getPredmet().getBrojBodova()+"");
